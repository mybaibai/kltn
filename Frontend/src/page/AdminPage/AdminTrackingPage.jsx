...
export default function AdminTrackingPage() {
  ...
  useEffect(() => {
    if (!sosId) return;
    fetchSos();
    const interval = setInterval(fetchSos, 10_000);
  ...
  const userPos = coords ? { ...coords, label: 'NẠN NHÂN' } : null;
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 relative">
        <MapView userPosition={userPos} teamPosition={teamPos} height="100%" />
      </div>
      ...
      <div className="w-[380px] shrink-0 overflow-y-auto border-l border-[#E8E8EC] bg-white">
        <div className="p-5 space-y-5">
          ...
          <button
            type="button"
            onClick={() => { setLoading(true); fetchSos(); }}
