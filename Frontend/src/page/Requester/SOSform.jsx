    ...
    <div className="fixed inset-0 z-[99999] bg-black/40 flex items-center justify-center p-4 overflow-y-auto">
      <div className="w-full max-w-xl bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-6 space-y-6 overflow-y-auto flex-1">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Vui lòng nhập thông tin bổ sung giúp đội cứu trợ hỗ trợ nhanh và chính xác hơn..."
              className="w-full bg-gray-100 rounded-xl text-sm px-4 py-3"
            />
          </div>
        ...
        <div className="px-6 py-4 border-t bg-gray-100 flex flex-col gap-4 flex-shrink-0">
          ...
          <button
            onClick={onCancel}
            className="w-full py-2 text-gray-500 font-semibold hover:bg-gray-200 rounded-xl transition-colors"
          >
            Hủy
          </button>
